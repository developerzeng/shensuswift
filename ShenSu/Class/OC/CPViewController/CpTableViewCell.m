...
-(void)setPoi:(AMapPOI *)poi{
    ...
    if(!_poi.images.firstObject.url){
        [self.cpImage setImageWithURLWithUrl:@"http://store.is.autonavi.com/showpic/57e00e51f243476dd5caf720139009aa"];
   
    
    }else{
      [self.cpImage setImageWithURLWithUrl:_poi.images.firstObject.url];
    }
