...
- (void)viewDidLoad {
    ...
    [self setLeftButtonClicked:^(id btn) {
        [weak.navigationController popToViewControllerWithViewClass:[SSBuyLottreyViewController class]];
    }];
...
- (IBAction)goBtnClick:(id)sender {
    ...
    [self.navigationController popToViewControllerWithViewClass:[SSBuyLottreyViewController class]];
}
