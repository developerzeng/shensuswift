...
class PfMyViewController: BaseViewController {
	var collectionView: UICollectionView!
	var spacefloat: CGFloat = 5.0
	var imageHeight = UIScreen.main.bounds.width * 1200 / 1920
	var userHeader: PfUserHeaderCollectionReusableView?
	...
	override func viewDidLoad() {
		...
		collectionView.register(UINib.init(nibName: "PfMycenterCollectionViewCell", bundle: Bundle.main), forCellWithReuseIdentifier: "cell")
		collectionView.register(UINib.init(nibName: "PfUserHeaderCollectionReusableView", bundle: Bundle.main), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "header")
...
extension PfMyViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? PfMycenterCollectionViewCell
		cell?.setModel(model: dataArray[indexPath.row])
		return cell!
	}
	func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
		if kind == UICollectionElementKindSectionHeader {
			userHeader = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "header", for: indexPath) as? PfUserHeaderCollectionReusableView
	...
	func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
		...
		case 1:
			...
			_ = self.navigationController?.pushViewController(vc, animated: true)
		case 2:
			let vc = PfLotterypushTableViewController()
			_ = self.navigationController?.pushViewController(vc, animated: true)
			break
		case 3:
		...
		case 4:
			let vc = PfAboutUsViewController()
			_ = self.navigationController?.pushViewController(vc, animated: true)
			break
		default:
			break
