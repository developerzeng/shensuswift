//
//  UserPfBuyListViewController.swift
//  ShenSu
//
...
class UserPfBuyListViewController: BaseViewController {
	var tableView: UITableView!
	var dataArray = Array<PfLotteryListModel>()
...
extension UserPfBuyListViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? UserPfBuyListTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("UserPfBuyListTableViewCell", owner: self, options: nil)?.first as? UserPfBuyListTableViewCell
		}
