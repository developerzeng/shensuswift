...
class PfSetupViewController: BaseViewController {
...
extension PfSetupViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? PfSetupTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("PfSetupTableViewCell", owner: self, options: nil)?.first as? PfSetupTableViewCell
		}
