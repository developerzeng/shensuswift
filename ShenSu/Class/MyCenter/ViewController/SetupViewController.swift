...
extension SetupViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? SetupTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("SetupTableViewCell", owner: self, options: nil)?.first as? SetupTableViewCell
		}
