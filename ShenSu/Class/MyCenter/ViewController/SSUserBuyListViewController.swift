//
//  UserSSBuyListViewController.swift
//  ShenSu
//
...
class UserSSBuyListViewController: BaseViewController {
	var tableView: UITableView!
	var dataArray = Array<SSLotteryListModel>()
...
extension UserSSBuyListViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? UserSSBuyListTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("UserSSBuyListTableViewCell", owner: self, options: nil)?.first as? UserSSBuyListTableViewCell
		}
