...
import WebKit
import EasyPeasy
class ZstViewController: BaseViewController,WKUIDelegate,WKNavigationDelegate {
    var wkView : WKWebView?
    var zstCon: ZstControl!
    var url: String! {
        didSet{
    ...
    override func viewDidLoad() {
        ...
        zstCon = ZstControl(frame: self.view.bounds)
