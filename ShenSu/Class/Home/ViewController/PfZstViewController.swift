...
import WebKit
import EasyPeasy
class PfZstViewController: BaseViewController,WKUIDelegate,WKNavigationDelegate {
    var wkView : WKWebView?
    var zstCon: PfZstControl!
    var url: String! {
        didSet{
    ...
    override func viewDidLoad() {
        ...
        zstCon = PfZstControl(frame: self.view.bounds)
