...
import EasyPeasy
import SwiftyJSON
class PfSeachViewController: BaseViewController {
...
extension PfSeachViewController: UISearchBarDelegate , UITableViewDelegate , UITableViewDataSource {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        seachBar.endEditing(true)
        if dataArray.count > indexPath.row {
        let vc = PfSeachOpenViewController()
