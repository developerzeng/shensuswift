...
class PfBuyListViewController: BaseViewController {
	var footerView: PfBuyLotteryFooterView!
	var tableView: UITableView!
	var lotteryArray = Array<PfLotteryListModel>()
...
extension PfBuyListViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? PfBuyListTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("PfBuyListTableViewCell", owner: self, options: nil)?.first as? PfBuyListTableViewCell
		}
