...
import SwiftyJSON
import EasyPeasy
class PfHomeHeaderView: UICollectionReusableView {
	var zpbannar: LLCycleScrollView!
	var bannarArray = Array<PfBannarModel>()
	var chooseView: PfChooseView!
    var homcellHead: PfHomecellHeadCollectionReusableView!
