...
import UIKit
import EasyPeasy
class PfBuyViewHeaderView: UIView {
	var rowCount: Int {
...
extension PfBuyViewHeaderView: UITableViewDataSource, UITableViewDelegate {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableview.dequeueReusableCell(withIdentifier: "cell") as? PfBuyViewTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("PfBuyViewTableViewCell", owner: self, options: nil)?.first as! PfBuyViewTableViewCell?
		}
