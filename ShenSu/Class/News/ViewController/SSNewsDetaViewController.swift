//
//  SSNewsDetaViewController.swift
//  ShenSu
//
...
class SSNewsDetaViewController: BaseViewController {
    var agentId: Int = 0
    ...
    override func loadView() {
        Bundle.main.loadNibNamed("SSNewsDetaViewController", owner: self, options: nil)
    }
