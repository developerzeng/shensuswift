...
class LotteryDetaViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
	var tableView: UITableView!
	var lotterModel: LotteryJSModel!
...
//		}
	...
	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		if lotteryinfoArray.count > indexPath.row {
			let vc = LotteryDetaTypeViewController()
