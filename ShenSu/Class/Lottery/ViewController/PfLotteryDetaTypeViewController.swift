//
//  PfLotteryDetaTypeViewController.swift
//  ShenSu
//
...
import UIKit
import EasyPeasy
class PfLotteryDetaTypeViewController: BaseViewController {
	var tableView: UITableView!
	var headerView: PfLotteryDetaHeaderView!
	var lotteryName: String = ""
	var models = PfLotteryJSModel()
	...
	override func viewDidLoad() {
		...
		headerView = PfLotteryDetaHeaderView(frame: CGRect(x: 0, y: 0, w: self.view.width, h: 165))
...
extension PfLotteryDetaTypeViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? PfLotteryDetaTypeTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("PfLotteryDetaTypeTableViewCell", owner: self, options: nil)?.first as? PfLotteryDetaTypeTableViewCell
		}
