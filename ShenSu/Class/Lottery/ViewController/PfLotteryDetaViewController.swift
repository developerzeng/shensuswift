//
//  PfPfLotteryDetaViewController.swift
//  ShenSu
//
...
class PfPfLotteryDetaViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
	var tableView: UITableView!
	var lotterModel: PfLotteryJSModel!
...
//		}
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		var cell = tableView.dequeueReusableCell(withIdentifier: "cell") as? PfLotteryDetaTableViewCell
		if cell == nil {
			cell = Bundle.main.loadNibNamed("PfLotteryDetaTableViewCell", owner: self, options: nil)?.first as? PfLotteryDetaTableViewCell
		}
	...
	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		if lotteryinfoArray.count > indexPath.row {
			let vc = PfLotteryDetaTypeViewController()
